...
namespace CondoHub.Controllers
{
    ...
    public class PropertiesController : Controller
    {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            if (hasContracts)
            {
                var errorMessage = "Não é possível excluir o imóvel enquanto existirem contratos vinculados. Remova ou reatribua-os primeiro.";
                ...
                return RedirectToAction(nameof(Detalhes), new { id = id.Value });
            }
            ...
            {
                var errorMessage = "Erro ao excluir o imóvel. Verifique se há registros vinculados.";
